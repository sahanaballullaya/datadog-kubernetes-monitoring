...
!\[Kubernetes Infrastructure](screenshots/01-kubernetes-infrastructure.png)



\### Container Metrics

!\[Container Metrics](screenshots/03-container-metrics.png)



\### Datadog Agent Running

!\[Datadog Agent](screenshots/05-datadog-agent-running.png)
...
&#x20; --from-literal=api-key=YOUR\_API\_KEY \\
